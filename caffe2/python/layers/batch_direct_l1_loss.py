## @package batch_direct_l1_loss
# Module caffe2.python.layers.batch_direct_l1_loss
...
class BatchDirectL1Loss(ModelLayer):

    def __init__(self, model, input_record, name='batch_direct_l1_loss', **kwargs):
        super(BatchDirectL1Loss, self).__init__(model, name, input_record, **kwargs)
